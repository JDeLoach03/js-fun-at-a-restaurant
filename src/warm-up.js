...
if (stockCount >= 1) {
  console.log(`I'm gong to eat some ${food}!`)
} else {
...
var vegetables = ['carrots', 'onion', 'kale', 'tomatoes', 'spinach'];
...
// different fruits.
var fruits = ['apples', 'bananas', 'mangos', 'grapes', 'orange', 'watermelon', 'apricots'];
